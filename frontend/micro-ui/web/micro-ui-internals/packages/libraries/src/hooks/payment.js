...
export const useFetchCitizenBillsForBuissnessService = ({ businessService, ...filters }, config = {}) => {
  ...
  */
  const skipBusinessServices = ["adv-services", "chb-services", "pet-services", "sv-services", "request-service.mobile_toilet", "request-service.water_tanker"];
