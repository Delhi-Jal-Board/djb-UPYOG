import { AddFilled, Button, Header, InboxSearchComposer, Loader, Dropdown, Card, CardLabel, LabelFieldPair, ActionBar, SubmitBar } from "@djb25/workbench-ui-react-components";
    ...
    <React.Fragment>
      <Card className="manage-master-wrapper">
        <div className="workbench-form-grid-3">
          <LabelFieldPair>
            <CardLabel className="card-label-smaller">{t("WBH_MODULE_NAME")}</CardLabel>
            <div className="field">
              <Dropdown
