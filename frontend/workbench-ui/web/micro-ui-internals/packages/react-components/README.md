...
```bash
npm install --save @djb25/workbench-ui-react-components
```
...
```json
"@djb25/workbench-ui-react-components":"1.5.24",
```
...
import MyComponent from "@djb25/workbench-ui-react-components";
...
```jsx
    import { InboxSearchComposer } from "@djb25/workbench-ui-react-components";
...
```jsx
    import { FormComposerV2 as FormComposer } from "@djb25/workbench-ui-react-components";
