...
```bash
npm install --save @djb25/workbench-ui-svg-components
```
...
```json
"@djb25/workbench-ui-svg-components":"0.0.1",
```
...
```jsx
import { Accessibility } from "@djb25/workbench-ui-svg-components";
...
```jsx
import { SVG } from "@djb25/workbench-ui-react-components";
